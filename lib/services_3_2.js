...
export const Services_3_2 = {
	...
	TOOL_MOBILE_GET_CONFIG: {
		 ...
		 * If section is omitted, all sections will be returned.
		 * @param token The login token for your moodle user.
		 * @param section The section to be filtered. Available are:
		 * @returns {{wsfunction: string, wstoken: *, moodlewsrestformat: string}}
		 */
		args: function (token, section="") {
			return {
