...
export const Services_3_2 = {
	...
	CORE_COURSE_CREATE_CATEGORIES: {
		...
		@param parent int  Default to "0" //the parent category id inside which the new category will be created- set to 0 for a root category
		@param idnumber string  Optional //the new category idnumber
		@param description string  Optional //the new category description
		@param descriptionformat int  Default to "1" //description format (1 = HTML, 0 = MOODLE, 2 = PLAIN or 4 = MARKDOWN)
		...
		*/
		args: function(token, name, parent, idnumber=null, description=null, descriptionformat=null, theme=null, wsRestFormat = null) {
			...
			argsObj['moodlewsrestformat'] = (wsRestFormat ? wsRestFormat : this.wsRestFormat);
	...
	CORE_ENROL_GET_ENROLLED_USERS: {
		 ...
		 * Options require format {name: String, value: String} where the value assigend to name is one of the above.
		 */
		args: function (token, courseId, options = [], wsRestFormat = 'json') {
			return {
