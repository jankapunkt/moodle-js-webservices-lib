export const Services_3_2 = {
	...
	MOODLE_MOBILE_APP_SERVICE:"moodle_mobile_app",

	AUTH_GET_TOKEN: {
		name: "",
		description: "Default service for login.",
		args: function(username, password, resultformat = 'json', followAllRedirects = false){
			return {
				username: username,
				password: password,
				service: this.MOODLE_MOBILE_APP_SERVICE,
